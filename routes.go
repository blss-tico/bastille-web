...
func templatesRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/console", consoleHandlerTplt)
	...
	mux.HandleFunc("/edit", editHandlerTplt)
	...
	mux.HandleFunc("/rdr", rdrHandlerTplt)
	...
	mux.HandleFunc("/verify", verifyHandlerTplt)
}
...
func dataRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /console", loggingMiddleware(consoleHandler))
	...
	mux.HandleFunc("POST /edit", loggingMiddleware(editHandler))
	...
	mux.HandleFunc("POST /rdr", loggingMiddleware(rdrHandler))
	...
	mux.HandleFunc("POST /verify", loggingMiddleware(verifyHandler))
}
